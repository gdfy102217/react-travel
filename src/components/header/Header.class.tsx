...
type PropsType = RouteComponentProps // react-router props
  & WithTranslation // i18n props
  & ReturnType<typeof mapStateToProps> // redux store props
  & ReturnType<typeof mapDispatchToProps>; // redux dispatch props
